...
function drawHistogram (ctx, margin, months, downloads, days, width, max, maxText) {
...
function draw (options, pkginfo) {
  var margin       = MARGIN
    ...
    , max          = pkginfo.downloads
        ? pkginfo.downloads.reduce(function (p, c) {
