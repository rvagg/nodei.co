    ...
    <div class="container">
      <header class="hero">
        ...
        <div class="hero-examples">
          <img src="/npm/express.svg?style=shields&data=n,v,d&downloads=true" alt="Express badge example">
          <img src="/npm/typescript.svg?data=s,d&stars=true&downloads=true" alt="TypeScript badge example">
        ...
        <section class="styles-section">
          ...
          <div class="options-grid">
            <div class="option-card">
              ...
              <div class="option-example">
                ...
                <img src="/npm/express.svg?style=shields&data=n,v,u,d&downloads=true" alt="Multi-data shields" loading="lazy" style="margin-top: 8px;">
              </div>
            ...
            <div class="option-card">
              ...
              <div class="option-example">
                <img src="/npm/express.svg?style=flat&data=n,v,d&downloads=true" alt="Flat style" loading="lazy">
                <img src="/npm/express.svg?style=flat-square&data=downloads&downloads=true" alt="Flat square style" loading="lazy" style="margin-top: 8px;">
              </div>
              <div style="display: flex; flex-direction: column; gap: 8px; margin-top: 12px;">
            ...
            <div class="option-card">
              ...
              <div class="option-example">
                ...
                <img src="/npm/@babel/core.svg?style=flat&data=n,d&downloads=true" alt="Scoped package flat" loading="lazy" style="margin-top: 8px;">
              </div>
              <div style="display: flex; flex-direction: column; gap: 8px; margin-top: 12px;">
            ...
            <div class="option-card">
              ...
              <div class="option-example">
                ...
                <img src="/npm/vite.svg?style=flat&data=downloads&downloads=true" alt="Downloads only" loading="lazy" style="margin-left: 4px;">
          ...
          <div class="options-grid">
            ...
            <div class="option-card">
              ...
              <div class="option-example">
                <img src="/npm/react.svg?data=s,d&stars=true&downloads=true" alt="With data" loading="lazy">
              </div>
            ...
            <div class="api-group">
              ...
              <div class="api-examples">
                ...
                <div class="api-example">
                  ...
                  <code>/npm/express.svg?downloads=true&stars=true</code>
                  <p>Backwards compatible - adds download and star counts</p>
                </div>
              </div>
            </div>
