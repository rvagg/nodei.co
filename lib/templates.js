  ...
  if (!options.mini) {
    if (options.compact) {
      ...
      if (params.showStars) {
        ...
        contentSection += `
      <!-- Stars -->
      <text x="${center - (starTextWidth + 10) / 2}" y="${starY}" class="main-text">
        ${starText}
      </text>
      <text x="${center + (starTextWidth + 10) / 2 - 7}" y="${starY + 0.5}" class="star-icon">
        ★
      </text>`
      }
    }
          ...
          <div class="example-grid">
            <div class="example-item">
              <div class="badge-preview">
                <img src="/npm/react.svg" alt="React badge" loading="lazy">
              </div>
              <code class="url-display">nodei.co/npm/react.svg</code>
            </div>

            <div class="example-item">
              <div class="badge-preview">
                <img src="/npm/typescript.svg?stars=true" alt="TypeScript badge with stars" loading="lazy">
              </div>
              <code class="url-display">nodei.co/npm/typescript.svg?stars=true</code>
            </div>

            <div class="example-item">
              <div class="badge-preview">
                <img src="/npm/axios.svg?compact=true" alt="Axios compact badge" loading="lazy">
              </div>
              <code class="url-display">nodei.co/npm/axios.svg?compact=true</code>
            </div>

            <div class="example-item">
              <div class="badge-preview">
                <img src="/npm/@types/node.svg?mini=true" alt="Scoped package badge" loading="lazy">
              </div>
              <code class="url-display">nodei.co/npm/@types/node.svg?mini=true</code>
            </div>
          </div>
        </section>
