    ...
    <div class="container">
      <header class="hero">
        ...
        <div class="hero-examples">
          ...
          <img src="/npm/typescript.svg?data=s,d&color=blue" alt="TypeScript badge example">
          <img src="/npm/@babel/core.svg?style=flat&data=n,v&color=brightgreen" alt="Babel badge example">
          <img src="/npm/js-sha3.svg?style=mini&color=orange" alt="js-sha3 badge example">
        </div>
      </header>
      ...
      <main class="content">
              ...
              <div class="option-group">
                ...
                <div class="color-options">
                  <label class="color-swatch-label">
                    ...
                    <span class="color-swatch" style="background-color: #cb3837;" title="Default (npm red)"></span>
                  </label>
                  <label class="color-swatch-label">
                    <input type="radio" name="color" value="brightgreen">
                    <span class="color-swatch" style="background-color: #4c1;" title="Bright Green"></span>
                  </label>
                  <label class="color-swatch-label">
                    <input type="radio" name="color" value="green">
                    <span class="color-swatch" style="background-color: #97ca00;" title="Green"></span>
                  </label>
                  <label class="color-swatch-label">
                    <input type="radio" name="color" value="yellowgreen">
                    <span class="color-swatch" style="background-color: #a4a61d;" title="Yellow Green"></span>
                  </label>
                  <label class="color-swatch-label">
                    <input type="radio" name="color" value="yellow">
                    <span class="color-swatch" style="background-color: #dfb317;" title="Yellow"></span>
                  </label>
                  <label class="color-swatch-label">
                    <input type="radio" name="color" value="orange">
                    <span class="color-swatch" style="background-color: #fe7d37;" title="Orange"></span>
                  </label>
                  <label class="color-swatch-label">
                    <input type="radio" name="color" value="red">
                    <span class="color-swatch" style="background-color: #e05d44;" title="Red"></span>
                  </label>
                  <label class="color-swatch-label">
                    <input type="radio" name="color" value="blue">
                    <span class="color-swatch" style="background-color: #007ec6;" title="Blue"></span>
                  </label>
                  <label class="color-swatch-label">
                    <input type="radio" name="color" value="lightgrey">
                    <span class="color-swatch" style="background-color: #9f9f9f;" title="Light Grey"></span>
                  </label>
                </div>
              </div>
            </div>
          ...
          <div class="options-grid">
            <div class="option-card">
              ...
              <div class="option-example">
                ...
                <img src="/npm/express.svg?style=shields&data=n,v,u,d&color=blue" alt="Multi-data shields" loading="lazy" style="margin-top: 8px;">
              </div>
              <div style="display: flex; flex-direction: column; gap: 8px; margin-top: 12px;">
                <code class="url-display" style="margin: 0;">?style=shields&data=version</code>
                <code class="url-display" style="margin: 0;">?style=shields&data=n,v,u,d&color=blue</code>
              </div>
            </div>
            ...
            <div class="option-card">
              ...
              <div class="option-example">
                <img src="/npm/express.svg?style=flat&data=n,v,d&color=brightgreen" alt="Flat style" loading="lazy">
                <img src="/npm/express.svg?style=flat-square&data=downloads" alt="Flat square style" loading="lazy" style="margin-top: 8px;">
              </div>
              <div style="display: flex; flex-direction: column; gap: 8px; margin-top: 12px;">
                <code class="url-display" style="margin: 0;">?style=flat&data=n,v,d&color=brightgreen</code>
        ...
        <section class="api-section">
          ...
          <div class="api-content">
            ...
            <div class="api-group">
              <h3>Color Options</h3>
              <p>Customize badge colors with the <code>color</code> parameter. Works with all badge styles!</p>
              <div class="api-table">
                <table>
                  <tr>
                    <th>Color</th>
                  ...
                  <tr>
                    <td>Default (npm red)</td>
                    <td><code>#cb3837</code></td>
                    <td><img src="/npm/tiny-package.svg?style=shields&data=v" alt="Default color" loading="lazy" style="vertical-align: middle;"></td>
                  </tr>
                  <tr>
                    <td>Blue</td>
                    <td><code>blue</code></td>
                    <td><img src="/npm/tiny-package.svg?style=shields&data=v&color=blue" alt="Blue badge" loading="lazy" style="vertical-align: middle;"></td>
                  </tr>
                  <tr>
                    <td>Bright Green</td>
                    <td><code>brightgreen</code></td>
                    <td><img src="/npm/tiny-package.svg?style=shields&data=v&color=brightgreen" alt="Bright green badge" loading="lazy" style="vertical-align: middle;"></td>
                  </tr>
                  <tr>
                    <td>Orange</td>
                    <td><code>orange</code></td>
                    <td><img src="/npm/tiny-package.svg?style=shields&data=v&color=orange" alt="Orange badge" loading="lazy" style="vertical-align: middle;"></td>
                  </tr>
                </table>
              </div>
              <p style="margin-top: 10px; font-size: 14px; color: #666;">
                Also supports: <code>green</code>, <code>yellowgreen</code>, <code>yellow</code>, <code>red</code>, <code>lightgrey</code>,
                or any hex color like <code>#ff6b6b</code>
              </p>
            </div>
